-- Reseed home_links — all 5 columns from original GreetingsPage
-- Deletes existing links for the user first.
...
BEGIN
  ...
  DELETE FROM home_links WHERE user_id = uid;
  ...
  -- Column 2: Agendy ŠG (empty — placeholder to keep column visible)
  (uid, 2, 'Agendy ŠG', '—', '#', 0),
